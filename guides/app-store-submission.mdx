...
description: Submit builds for App Store review and manage the submission lifecycle
---
...
- [Build Management](/api-reference/builds/list) - Manage and monitor builds