...
description: 'Use the official setup-asc action to automate App Store Connect workflows in GitHub Actions'
icon: 'github'
---
...
```yaml .github/workflows/testflight.yml
...
```yaml .github/workflows/testflight-release.yml
...
```yaml .github/workflows/app-store-submit.yml
...
```yaml .github/workflows/metadata-sync.yml
...
```yaml .github/workflows/crash-monitor.yml
...
```yaml .github/workflows/multi-app-deploy.yml
...
- [Commands Reference](/api-reference/commands)
