...
description: Common issues and solutions for the App Store Connect CLI
---
...
**Solution**: Check your API key role at https://appstoreconnect.apple.com/access/integrations/api
...
3. For security issues, use private reporting: https://github.com/rudrankriyam/App-Store-Connect-CLI/security/advisories/new
