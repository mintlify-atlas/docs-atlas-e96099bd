---
title: Workflows
description: Automate multi-step tasks by composing CLI commands and shell scripts in declarative JSON workflows.
---
...
- [Authentication](/getting-started/authentication) - Workflows inherit authentication
